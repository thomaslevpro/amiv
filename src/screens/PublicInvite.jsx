...
export default function PublicInvite({ token }) {
  ...
  if (error) return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#FFFFFF', gap: 12 }}>
        ...
        {rsvpDone ? (
          ...
          <div
            ...
            style={{
              ...
              background: rsvpLoading ? '#F5F5F5' : 'linear-gradient(135deg,#e055aa,#f5a623)',
